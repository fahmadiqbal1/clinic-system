...
class EquipmentController extends Controller
{
    ...
    {
        $equipment = Equipment::forDepartment('lab')->orderBy('name')->paginate(25);

        // Pending change requests for lab equipment (visible to all lab users)
        ...
        return view('laboratory.equipment.index', compact('equipment', 'pendingChanges'));
    }

    public function create(): View
    {
        return view('laboratory.equipment.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($user->hasRole('Owner')) {
            ...
            return redirect()->route('laboratory.equipment.index')
        ...
        ProcurementRequest::create([
            ...
            'change_payload' => array_merge($validated, ['department' => 'lab', 'is_active' => true]),
    ...
    {
        return view('laboratory.equipment.edit', compact('equipment'));
    }
