...
<div class="container mt-4">
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2 fade-in">
        <div>
            ...
            <p class="page-subtitle mb-0">Update lab equipment details</p>
        </div>
    ...
    <div class="glass-card p-4 fade-in delay-1" style="max-width:900px;">
            <form method="POST" action="{{ route('laboratory.equipment.update', $equipment) }}">
                @csrf
                @method('PATCH')
                <div class="row g-3">
                    <div class="col-md-6">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    @else
                        <button type="submit" class="btn btn-warning"><i class="bi bi-send me-1"></i>Submit Update for Approval</button>
                    @endif
