...
<div class="fade-in" style="max-width:700px;">
    <div class="page-header mb-4">
        <div>
            <h1 class="page-title"><i class="bi bi-door-open me-2"></i>Add Clinic Room</h1>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                        value="{{ old('name') }}" placeholder="e.g. Consultation Room 1" required>
                ...
                <div class="col-12">
                    ...
                    <textarea name="equipment_notes" class="form-control @error('equipment_notes') is-invalid @enderror"
                        rows="3" placeholder="List key equipment installed in this room...">{{ old('equipment_notes') }}</textarea>
