...
<div class="container mt-4">
        ...
        <div class="col-6 col-md-2">
            <div class="card hover-lift" style="border-left:3px solid var(--accent-success);">
                <div class="card-body glass-stat text-center py-2">
                    <div class="stat-value mb-0" style="font-size:1.4rem;">{{ $kpi['dispensed_today'] }}</div>
                    <div class="stat-label" style="font-size:0.7rem;">Dispensed Today</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-2">
            <div class="card hover-lift" style="border-left:3px solid var(--accent-info);">
                <div class="card-body glass-stat text-center py-2">
                    <div class="stat-value mb-0" style="font-size:1.4rem;">{{ $kpi['dispensed_month'] }}</div>
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            ...
            @if(\App\Models\PlatformSetting::isEnabled('ui.livewire.pharmacy_barcode'))
            {{-- Livewire Barcode Dispense — direct stock-out via scanner --}}
            <div class="card mb-4 fade-in delay-5">
                <div class="card-header"><i class="bi bi-lightning-charge me-2" style="color:var(--accent-success);"></i>Barcode Dispense</div>
                <div class="card-body p-0">
                    <livewire:pharmacy.barcode-dispense />
                </div>
            </div>
            @endif
